...
mysql_real_escape_string、addslashes会在引号前加上反斜杠`\`，如果mysql使用宽字符集（比如`gbk`），`%df\`会被识别成一个字符`運`，从而再次产生单引号

![](assets/sql绕过/Pasted%20image%2020251210205341.png)

![](assets/sql绕过/Pasted%20image%2020251210210813.png)
